...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row field_size">
		...
		<?php echo CHtml::activeTextField($model,'field_size',array('readonly'=> ($model->id && $model->field_type != "TEXT") )); ?>
		<?php echo CHtml::error($model,'field_size'); ?>
		<p class="hint"><?php echo UserModule::t('Field size of the column in the database or max length of TEXT field'); ?></p>
	</div>
