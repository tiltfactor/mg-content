...
class TwoPlayerBonus extends MGPluginModel implements MGPluginModelInterface
{
  ...
  public function attributeLabels() {
    return array(
      'score_new' => Yii::t('app', 'Bonus for Both Players (same new tag)'),
      'score_match' => Yii::t('app', 'Bonus for Both Players (same matched tag)'),
    );
  }
