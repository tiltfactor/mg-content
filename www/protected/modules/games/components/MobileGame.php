<?php
/**
 * Implementation of the needed methods for Mobile games.
 *
 * @package    MG
 * @author     Vincent Van Uffelen <novazembla@gmail.com>
 */
class MobileGame extends MGGame implements MGGameInterface {
  ...
  public function getTurn(&$game, &$game_model, $tags=array()) {
    ...
    if ($game->turn < $game->turns) {
	  ...
	  // We might want larger images on the Final Screen...
  ...
  public function parseTags(&$game, &$game_model) {
    ...
    foreach ($game->request->submissions as $submission) {
      ...
      // the submission has in the case of Mobile just one image and a
      // string of comma-separated tags.
