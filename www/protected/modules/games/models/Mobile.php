...
/**
 */
class Mobile extends MGGameModel implements MGGameModelInterface
{
  ...
  public $name = "Mobile";
  public $arcade_image = "mobile_arcade.png";
  ...
  public function fbvLoad() {
    ...
    if (is_array($game_data)) {
      ...
      //error_log("Mobile: fbvLoad: " . var_export($this->more_info_url, true), 0);
      ...
      // INSERT DEBUGGING HERE...
      //error_log("Mobile: fbvLoad: game_data is not an array..", 0);
    }
  }
