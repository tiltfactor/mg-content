...
class GuessWhat extends MGGameModel implements MGGameModelInterface
{
  ...
  public function attributeLabels() {
    return array(
      ...
      'image_width' => Yii::t('app', 'Tagger\'s Maximum Media Width'),
      'image_height' => Yii::t('app', 'Tagger\'s Maximum Media Height'),
      'image_grid_width' => Yii::t('app', 'Guesser\'s Maximum Media Width'),
      'image_grid_height' => Yii::t('app', 'Guesser\'s Maximum Media Height'),
