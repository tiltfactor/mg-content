...
<p>All tag uses of "<?php echo $tag_from->tag; ?>" will replaced by tag uses of "<?php echo $tag_to->tag; ?>." An original version record will be added to each replaced tag to allow to account for this tag merge. 
</p>
