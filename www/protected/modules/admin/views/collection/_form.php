<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->error($model, 'last_access_interval'); ?>Time in seconds to pass before an media can be used
        again. Set to 0 to deactivate
    </div>
    <!-- row -->
    <div class="row">
        <?php echo $form->labelEx($model, 'ip_restrict'); ?>
        <?php echo $form->dropDownList($model, 'ip_restrict', Collection::itemAlias('Ip Restrict')); ?>
        <?php echo $form->error($model, 'ip_restrict'); ?>
    </div>
    <div class="row">
