...
<p><b><?php echo $count_files ?></b> files have been found in the /uploads/ftp folder. Please 
  enter a batch id and click the button. Depending on the number of images to be imported the process might take a while. 
  You can leave the page and return later to import further available images.</p>
