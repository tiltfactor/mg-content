...
<ol>
  ...
  <li><a href="<?php echo Yii::app()->baseUrl; ?>/index.php/admin/collection" target="_blank">Create collections</a> and <a href="<?php echo Yii::app()->baseUrl; ?>/index.php/admin/import" target="_blank">import medias</a>.</li>
