 ...
 */
class KImage_ImageMagick_Driver extends KImage_Driver {
	...
	public function flip($dir)
	{
		...
		$dir = ($dir === KImage::HORIZONTAL) ? '-flop' : '-flip';
