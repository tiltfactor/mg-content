...
Yii::import('application.extensions.image.KImage_Driver');
...
class KImage {
	...
	public function __construct($image, $config = NULL)
	{
		...
		$driver = 'KImage_'.ucfirst($this->config['driver']).'_Driver';
		...
		// Validate the driver
		if ( ! ($this->driver instanceof KImage_Driver))
			throw new CException('image driver must be implement KImage_Driver class');
	}
	 ...
	 * wish to use height as master dim, set $image->master_dim = KImage::HEIGHT
	 * This method is chainable.
	 *
	 * @throws  Kohana_Exception
	 * @param   integer  width
	 * @param   integer  height
	 * @param   integer  one of: KImage::NONE, KImage::AUTO, KImage::WIDTH, KImage::HEIGHT
	 * @return  object
	 */
